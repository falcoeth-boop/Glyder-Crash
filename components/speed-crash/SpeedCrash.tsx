...
const SpeedCrash: React.FC<SpeedCrashProps> = ({ game }) => {
    ...
    // ── Game hooks ──────────────────────────────────────────────
    const { gameState, placeBet, setTarget, setBet, isActive, canBet, validationError } = useCrashGame();
    ...
    const playGame = useCallback(async () => {
        ...
        // Small delay for UI feedback, then place bet
        setTimeout(() => {
    ...
    }, [canBet, validationError, gameState.betAmount, gameState.balance, placeBet]);
