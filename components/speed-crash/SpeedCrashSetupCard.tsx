                ...
                <>
                    <CardContent className="font-roboto">
                        ...
                        <Button
                            ...
                            disabled={betAmount <= 0 || betAmount > walletBalance || isLoading || isGamePaused}
                        >
                            ...
                            <div className="flex gap-2 mb-3">
                                <div className="relative flex-1">
                                    <input
                                        ...
                                        disabled={isLoading || isGamePaused}
                                        className="w-full bg-[#1E2A35] text-white text-sm font-bold rounded-lg px-3 py-2 pr-8 outline-none focus:ring-2 placeholder:text-[#91989C] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none disabled:opacity-50 disabled:cursor-not-allowed"
